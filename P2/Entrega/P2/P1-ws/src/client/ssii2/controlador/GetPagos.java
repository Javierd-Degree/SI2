...
public class GetPagos extends ServletRaiz {
    ...
    */
    ...
    String value = getServletContext().getInitParameter("remoteEndpoint");
    ...
    List<PagoBean> pagos_aux = dao.getPagos(idComercio);
		PagoBean[] pagos = pagos_aux.toArray(new PagoBean[pagos_aux.size()]);
